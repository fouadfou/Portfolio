    ...
    >
      <div className="background-image relative px-[10%]  pb-9 pt-5  h-fit bg-[#F7F7F8]">
        ...
        >
          {Object.values(project.images).map((img, index) => (
            <SwiperSlide
              key={index}
              className={` p-2 swiper-slide transition-all ease-linear duration-500 bg-opacity-20  bg-white h-[350px] w-[250px] rounded-xl shadow-md`}
            >
      ...
      <div className=" p-10">
        <div className="p-12 flex flex-col  gap-2 bg-[#F7F7F8]  rounded-lg border-[2px] border-opacity-70 border-[#FFBF00]">
          <h1 className="text-2xl mb-1 text-[#FFBF00] font-extrabold">
            Project Details :
          </h1>
          <h2>
          ...
          {project.type !== "Design" && (
            <div className="dev-technologies flex flex-col gap-1 ">
              <h1 className="text-2xl mb-2 mt-6 text-[#FFBF00] font-extrabold">
